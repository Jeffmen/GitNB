...
public abstract class RetrofitNetworkAbs {
    ...
    private void sureToAnthorize(final Activity context){
		Dialog dialog = new AlertDialog.Builder(context).setTitle("Caution")
				.setMessage("The GitHup request is unauthorized. Please anthorize again?")
				.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					
					@Override
					public void onClick(DialogInterface dialog, int which) {
						Intent intent = new Intent(context, GitHubAnthorizeActivity.class);
